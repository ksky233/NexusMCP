...
const buttonVariants = cva(
  "inline-flex min-h-10 cursor-pointer select-none items-center justify-center gap-2 rounded-[8px] border px-4 text-sm font-normal tracking-[0.02em] transition-[background-color,border-color,color,transform,box-shadow,opacity] duration-200 outline-none hover:-translate-y-px active:translate-y-0 focus-visible:ring-2 focus-visible:ring-slate/45 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:translate-y-0 disabled:border-line disabled:bg-mist/80 disabled:text-slate/45 disabled:shadow-none",
  {
    variants: {
      variant: {
        primary: "border-ink bg-ink text-mist shadow-hairline hover:border-slate hover:bg-slate",
        secondary:
          "border-slate/55 bg-paper text-slate hover:border-slate/72 hover:bg-mist/70 hover:text-ink",
